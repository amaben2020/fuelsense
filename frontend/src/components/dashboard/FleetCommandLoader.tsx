...
export function FleetCommandLoader() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#0b1326] px-6">
      <div
        aria-hidden
      ...
      <div className="relative w-full max-w-[420px]">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-8 top-1/2 h-40 -translate-y-1/2 rounded-full bg-[#276EF1]/20 blur-3xl"
        />
        <Lottie
      ...
      <div className="relative mt-2 text-center">
        <p className="text-2xl font-bold tracking-tight text-[#b8c3ff]">FuelSense</p>
        <p className="mt-1 text-[10px] uppercase tracking-[0.22em] text-[#4edea3]">Command center</p>
        <p className="mt-5 text-sm font-medium text-[#c4c5d9]">
          Loading fleet command center
          <span className="fleet-loader-dots" aria-hidden>
            ...
          </span>
        </p>
        <p className="mt-2 text-xs text-[#8e90a2]">Syncing vehicles, routes, and live telemetry</p>
      </div>
    </div>
  );
}
